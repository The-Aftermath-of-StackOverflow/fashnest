    ...
    <Layout>
      <div className="flex gap-2 mt-8">
        <div className="w-1/2">
          ...
          <form>
            <div className="mb-4">
              <label for="formFile" className="mb-2 inline-block text-light">
            ...
            <div className="relative mb-4" data-te-input-wrapper-init>
              ...
              <label
                ...
                className="pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-light transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-light peer-data-[te-input-state-active]:-translate-y-[0.9rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none"
              >
                Enter Product URL
              </label>
            </div>
