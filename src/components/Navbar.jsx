  ...
  return (
    <div className="flex w-full justify-between">
      ...
      <button onClick={() => (session ? signOut() : signIn())}>
        <div className="relative inline-flex items-center px-10 py-2 overflow-hidden text-sm font-medium text-light border-2 border-pale-blue rounded-full hover:text-white group hover:bg-gray-50">
          ...
          <span className="relative">{session ? 'Sign Out' : 'Sign In'} </span>
        </div>
      </button>
    </div>
  )
